         ...
         <div id="main">
            ...
            <section id="two">
               <div className="inner">
                  ...
                  <p>
                     Nullam et orci eu lorem consequat tincidunt vivamus et sagittis libero. Mauris aliquet magna magna sed nunc rhoncus pharetra.
                     ...
                     Nullam et orci eu lorem consequat tincidunt. Vivamus et sagittis libero. Mauris aliquet magna magna sed nunc rhoncus amet
                     pharetra et feugiat tempus.
                  </p>
                  <ul className="actions">
                     <li>
...
export const getStaticProps = async () => {
   const sortPosts = () => {
      ...
      return allPosts.sort((a, b) => {
         return new moment(a.date).format("YYYY-MM-DD HH:mm:ss") < new moment(b.date).format("YYYY-MM-DD HH:mm:ss");
      });
   };
